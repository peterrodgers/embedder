...
/**
 * As GraphDrawer, but for DiagramPanel.
 *
...
/** Minimal constructor. */
	public DiagramDrawer(String inMenuText) {
		menuText = inMenuText;
	}

/** Trivial constructor. */
	public DiagramDrawer(int inAccelerator, String inMenuText) {
		acceleratorKey = inAccelerator;
		menuText = inMenuText;
	}

/** Trivial constructor. */
	public DiagramDrawer(int inAccelerator, String inMenuText, int inMnemonic) {
		acceleratorKey = inAccelerator;
		menuText = inMenuText;
...
/** Overwrite this with your layout method. */
