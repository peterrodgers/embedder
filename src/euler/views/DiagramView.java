...
/** Minimal constructor. */
	public DiagramView(String inMenuText) {
		menuText = inMenuText;
	}

/** Trivial constructor. */
	public DiagramView(int inAccelerator, String inMenuText) {
		acceleratorKey = inAccelerator;
		menuText = inMenuText;
	}

/** Trivial constructor. */
	public DiagramView(int inAccelerator, String inMenuText, int inMnemonic) {
		acceleratorKey = inAccelerator;
		menuText = inMenuText;
