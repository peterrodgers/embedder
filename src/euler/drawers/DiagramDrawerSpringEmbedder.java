 ...
 */
public class DiagramDrawerSpringEmbedder extends DiagramDrawer {
...
/** Trivial constructor. */
	public DiagramDrawerSpringEmbedder() {
		super(KeyEvent.VK_S,"Spring Embedder");
	}

/** Trivial constructor. */
	public DiagramDrawerSpringEmbedder(int key, String s) {
		super(key,s);
	}
/** Constructor. */
	public DiagramDrawerSpringEmbedder(int key, String s, boolean inRandomize) {
		super(key,s);
		randomize = inRandomize;
	}
/** Full constructor. */
	public DiagramDrawerSpringEmbedder(int key, String s, int mnemomic, boolean inRandomize) {
...
/** Draws the graph. */
	public void layout() {
		selectedNodes = diagramPanel.getSelection().getNodes();
		drawGraph(getDualGraph(),selectedNodes);
	}
	
	
	
	public void drawGraph(DualGraph dg, ArrayList<Node> fixedNodes) {
		
		selectedNodes = fixedNodes;
		...
		nodeBuffer.setUpNodes(dg.getNodes());
