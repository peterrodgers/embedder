...
//		testF();
	...
	public static void testA() {
		...
		*/
		...
		ArrayList dyTest = new ArrayList();
		...
		e1 = new Edge(n1,n2);
		if(pjr.graph.Util.round(e1.findLength(),2) != 5.0) {System.out.println("Test2.18.1 Fail");}
		e1 = new Edge(n2,n1);
		if(pjr.graph.Util.round(e1.findLength(),2) != 5.0) {System.out.println("Test2.18.2 Fail");}
		n1 = new Node(new Point(0,0));
		n2 = new Node(new Point(1,1));
		e1 = new Edge(n1,n2);
		e1.addBend(new Point(0,1));
		if(pjr.graph.Util.round(e1.findLength(),2) != 2.0) {System.out.println("Test2.18.3 Fail");}
		e1 = new Edge(n2,n1);
		e1.addBend(new Point(0,1));
		if(pjr.graph.Util.round(e1.findLength(),2) != 2.0) {System.out.println("Test2.18.4 Fail");}
		n1 = new Node(new Point(0,0));
		n2 = new Node(new Point(5,4));
		e1 = new Edge(n1,n2);
		e1.addBend(new Point(0,1));
		e1.addBend(new Point(1,1));
		if(pjr.graph.Util.round(e1.findLength(),2) != 7.0) {System.out.println("Test2.18.5 Fail");}
		e1 = new Edge(n2,n1);
		e1.addBend(new Point(5,3));
		e1.addBend(new Point(4,3));
		if(pjr.graph.Util.round(e1.findLength(),2) != 7.0) {System.out.println("Test2.18.6 Fail");}
		...
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.1 FAIL");}
		
		n1 = new Node("1");
		n2 = new Node("2");
		g.addNode(n1);
		g.addNode(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.2 FAIL");}
		
		nodeCycle.add(n1);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.3 FAIL");}
		nodeCycle.add(n2);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.4 FAIL");}
		
		g.addEdge(new Edge(n1,n2));
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.5 FAIL");}
		g.addEdge(new Edge(n1,n2));
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.6 FAIL");}
		...
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.7 FAIL");}

		g.addNode(n3);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.8 FAIL");}
		g.addEdge(new Edge(n2,n3));
		nodeCycle.add(n3);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.9 FAIL");}

		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n2);
		nodeCycle.add(n3);
		nodeCycle.add(n1);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.10 FAIL");}
		...
		nodeCycle = new ArrayList<Node>();
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.11 FAIL");}
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		nodeCycle.add(n3);
		nodeCycle.add(n4);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.12 FAIL");}
		g.addEdge(new Edge(n1,n4));
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.13 FAIL");}
		...
		nodeCycle.add(n2);
		nodeCycle.add(n4);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.14 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n3);
		nodeCycle.add(n4);
		nodeCycle.add(n2);
		nodeCycle.add(n1);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.15 FAIL");}
		
		g.addAdjacencyEdge("1","5");
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.16 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n2);
		nodeCycle.add(n1);
		nodeCycle.add(n4);
		nodeCycle.add(n3);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.17 FAIL");}
		g.addAdjacencyEdge("5","1");
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.18 FAIL");}
		g.addAdjacencyEdge("5","6");
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.19 FAIL");}
		g.addAdjacencyEdge("2","6");
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.20 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n2);
		nodeCycle.add(n4);
		nodeCycle.add(n3);
		nodeCycle.add(n1);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.21 FAIL");}
		g.addAdjacencyEdge("1","2");
		nodeCycle = new ArrayList<Node>();
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.22 FAIL");}
		nodeCycle.add(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.23 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n1);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.24 FAIL");}
		...
		nodeCycle.add(n4);
		nodeCycle.add(n1);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.25 FAIL");}
		g.addEdge(new Edge(n1,n4));
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.26 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		nodeCycle.add(n3);
		nodeCycle.add(n1);
		nodeCycle.add(n4);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.27 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n1);
		nodeCycle.add(n4);
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		nodeCycle.add(n3);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.28 FAIL");}
		...
		nodeCycle.add(n3);
		nodeCycle.add(n1);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.29 FAIL");}
		...
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.30 FAIL");}
		nodeCycle.add(n1);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.31 FAIL");}
		nodeCycle.add(n2);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.32 FAIL");}
		...
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.33 FAIL");}
		nodeCycle.add(n1);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.34 FAIL");}
		nodeCycle.add(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.35 FAIL");}
		nodeCycle.add(n1);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.36 FAIL");}
		nodeCycle.add(n2);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.37 FAIL");}
		...
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.38 FAIL");}
		nodeCycle.add(n3);
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.39 FAIL");}
		...
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.40 FAIL");}
		nodeCycle.add(n3);
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.41 FAIL");}
		nodeCycle.add(n3);
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.42 FAIL");}
		...
		nodeCycle.add(n2);
		nodeCycle.add(n3);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.43 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n1);
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		nodeCycle.add(n3);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.44 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		nodeCycle.add(n1);
		nodeCycle.add(n3);
		if(g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.45 FAIL");}
		nodeCycle = new ArrayList<Node>();
		nodeCycle.add(n1);
		nodeCycle.add(n2);
		nodeCycle.add(n3);
		if(!g.isNodeCycle(nodeCycle)) {System.out.println("Test 12.4.46 FAIL");}
		...
		fe1 = new FaceEdge(n1,n2);
		if(fe1.oppositeEnd(n1) != n2) {System.out.println("Test 12.5.1 FAIL");}
		if(fe1.oppositeEnd(n2) != n1) {System.out.println("Test 12.5.2 FAIL");}
		if(fe1.oppositeEnd(n3) != null) {System.out.println("Test 12.5.3 FAIL");}

		fe1 = new FaceEdge(n1,n1);
		if(fe1.oppositeEnd(n1) != n1) {System.out.println("Test 12.5.4 FAIL");}
		if(fe1.oppositeEnd(n2) != null) {System.out.println("Test 12.5.5 FAIL");}

		fe1 = new FaceEdge(n1,n2);
		fe2 = new FaceEdge(n3,n2);
		if(fe1.connectingNode(fe2) != n2) {System.out.println("Test 12.5.6 FAIL");}
		if(fe2.connectingNode(fe1) != n2) {System.out.println("Test 12.5.7 FAIL");}
		fe1 = new FaceEdge(n2,n1);
		fe2 = new FaceEdge(n3,n2);
		if(fe1.connectingNode(fe2) != n2) {System.out.println("Test 12.5.8 FAIL");}
		if(fe2.connectingNode(fe1) != n2) {System.out.println("Test 12.5.9 FAIL");}
		fe1 = new FaceEdge(n1,n2);
		fe2 = new FaceEdge(n2,n3);
		if(fe1.connectingNode(fe2) != n2) {System.out.println("Test 12.5.10 FAIL");}
		if(fe2.connectingNode(fe1) != n2) {System.out.println("Test 12.5.11 FAIL");}
		fe1 = new FaceEdge(n1,n2);
		fe2 = new FaceEdge(n3,n4);
		if(fe1.connectingNode(fe2) != null) {System.out.println("Test 12.5.12 FAIL");}
		if(fe2.connectingNode(fe1) != null) {System.out.println("Test 12.5.13 FAIL");}
		fe1 = new FaceEdge(n1,n1);
		fe2 = new FaceEdge(n2,n1);
		if(fe1.connectingNode(fe2) != n1) {System.out.println("Test 12.5.14 FAIL");}
		if(fe2.connectingNode(fe1) != n1) {System.out.println("Test 12.5.15 FAIL");}
		fe1 = new FaceEdge(n1,n1);
		fe2 = new FaceEdge(n1,n1);
		if(fe1.connectingNode(fe2) != n1) {System.out.println("Test 12.5.16 FAIL");}
		if(fe2.connectingNode(fe1) != n1) {System.out.println("Test 12.5.17 FAIL");}
		fe1 = new FaceEdge(n1,n1);
		fe2 = new FaceEdge(n2,n2);
		if(fe1.connectingNode(fe2) != null) {System.out.println("Test 12.5.18 FAIL");}
		if(fe2.connectingNode(fe1) != null) {System.out.println("Test 12.5.19 FAIL");}


		ArrayList<FaceEdge> feCycle = new ArrayList<FaceEdge>();
		
		g = new Graph();
		feCycle = new ArrayList<FaceEdge>();
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.1 FAIL");}
		...
		g.addNode(n2);
		g.addEdge(new Edge(n1,n2));
		g.addEdge(new Edge(n1,n1));
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.2 FAIL");}
		
		g = new Graph();
		n1 = new Node("1");
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.3 FAIL");}
		...
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n1));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.4 FAIL");}
		...
		g.addEdge(new Edge(n1,n2));
		g.addEdge(new Edge(n1,n3));
		g.addEdge(new Edge(n2,n2));
		g.addEdge(new Edge(n3,n2));
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.5 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n2,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.6 FAIL");}
		...
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.7 FAIL");}
		feCycle.add(new FaceEdge(n1,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.8 FAIL");}
		...
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.9 FAIL");}

		g.addEdge(new Edge(n1,n2));
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.10 FAIL");}
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.11 FAIL");}
		g.addEdge(new Edge(n1,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.12 FAIL");}
		...
		g.addEdge(new Edge(n3,n2));
		feCycle = new ArrayList<FaceEdge>();
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.13 FAIL");}
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.14 FAIL");}
		feCycle.add(new FaceEdge(n1,n3));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.15 FAIL");}
		feCycle.add(new FaceEdge(n3,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.16 FAIL");}
		...
		feCycle.add(new FaceEdge(n1,n3));
		feCycle.add(new FaceEdge(n3,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.17 FAIL");}
		g.addEdge(new Edge(n2,n3));
		g.addEdge(new Edge(n2,n1));
		g.addEdge(new Edge(n1,n3));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.18 FAIL");}
		...
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n3,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.18a FAIL");}
		...
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n2));
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n3,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.19 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.20 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n3,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.21 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n3,n4));
		feCycle.add(new FaceEdge(n4,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.22 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n3,n4));
		feCycle.add(new FaceEdge(n4,n1));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.23 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.24 FAIL");}
		feCycle.add(new FaceEdge(n1,n4));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.25 FAIL");}
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.26 FAIL");}
		g.addEdge(new Edge(n1,n2));
		g.addEdge(new Edge(n2,n3));
		g.addEdge(new Edge(n3,n4));
		g.addEdge(new Edge(n4,n1));
		...
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.27 FAIL");}
		feCycle.add(new FaceEdge(n1,n4));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.28 FAIL");}
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.29 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.30 FAIL");}
		g.addEdge(new Edge(n4,n1));
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n1,n4));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.31 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.32 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.33 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.34 FAIL");}
		g.addEdge(new Edge(n2,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.35 FAIL");}
		g.addAdjacencyEdge("1", "7");
		g.addAdjacencyEdge("2", "3");
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.36 FAIL");}
		g.addAdjacencyEdge("2", "2");
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.37 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n2,n1));
		feCycle.add(new FaceEdge(n1,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.38 FAIL");}
		g.addAdjacencyEdge("2", "2");
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.39 FAIL");}
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.40 FAIL");}
		g.addAdjacencyEdge("2", "3");
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n2));
		...
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n2));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.41 FAIL");}
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n2,n2));
		feCycle.add(new FaceEdge(n3,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.6.42 FAIL");}
		...
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.1 FAIL");}
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.2 FAIL");}

		g.addEdge(new Edge(n2,n1));
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.3 FAIL");}
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.4 FAIL");}
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.5 FAIL");}
		...
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n1,n2));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.6 FAIL");}
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.7 FAIL");}
		
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n1,n3));
		if(!g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.8 FAIL");}
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.9 FAIL");}
		
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n1,n3));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.10 FAIL");}
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.11 FAIL");}
		...
		feCycle.add(new FaceEdge(n3,n4));
		feCycle.add(new FaceEdge(n4,n1));
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.12 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n4,n1));
		feCycle.add(new FaceEdge(n4,n1));
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.13 FAIL");}
		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n4,n2));
		feCycle.add(new FaceEdge(n4,n2));
		if(g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.14 FAIL");}
		feCycle.add(new FaceEdge(n2,n3));
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n3,n4));
		feCycle.add(new FaceEdge(n4,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.15 FAIL");}
		if(g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.16 FAIL");}
		...
		feCycle.add(new FaceEdge(n3,n2));
		feCycle.add(new FaceEdge(n2,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.17 FAIL");}
		if(!g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.18 FAIL");}

		feCycle = new ArrayList<FaceEdge>();
		feCycle.add(new FaceEdge(n1,n2));
		feCycle.add(new FaceEdge(n2,n4));
		feCycle.add(new FaceEdge(n4,n3));
		feCycle.add(new FaceEdge(n3,n1));
		if(g.isFaceEdgeCycle(feCycle,true)) {System.out.println("Test 12.7.19 FAIL");}
		if(g.isFaceEdgeCycle(feCycle,false)) {System.out.println("Test 12.7.20 FAIL");}
	...
	public static void testC(){
		// test graph form faces function 
		System.out.println("| Test 15 START: Graph.formFace");
		
		Face face;
		ArrayList<FaceEdge> faceEdges;
		ArrayList<FaceEdge> fes;
		ArrayList<Node> faceNodes;
		
		Graph graph = new Graph();
		Node n1 = new Node("n1",new Point(100,100));
		Node n2 = new Node("n2",new Point(150,200));
		Node n3 = new Node("n3",new Point(60,180));
		...
		if(faces.size() != 2) {System.out.println("Test 15.1.1 FAIL");}
		face = faces.get(0);
		faceEdges = face.getFaceEdgeList();
		faceNodes = face.getNodeList();

		if(faceEdges.size() != 3) {System.out.println("Test 15.1.2 FAIL");}
		if(faceNodes.size() != 3) {System.out.println("Test 15.1.3 FAIL");}
		if(!faceNodes.contains(n1)) {System.out.println("Test 15.1.4 FAIL");}
		if(!faceNodes.contains(n2)) {System.out.println("Test 15.1.5 FAIL");}
		if(!faceNodes.contains(n3)) {System.out.println("Test 15.1.6 FAIL");}
//		 test for presence of edges		
		if(!face.hasEdge(e1)){System.out.println("Test 15.1.7 FAIL");}
		if(!face.hasEdge(e2)){System.out.println("Test 15.1.8 FAIL");}	
		if(!face.hasEdge(e3)){System.out.println("Test 15.1.9 FAIL");}	  		

		face = faces.get(1);
		faceEdges = face.getFaceEdgeList();
		faceNodes = face.getNodeList();
		if(faceEdges.size() != 3) {System.out.println("Test 15.2.1 FAIL");}
		if(faceNodes.size() != 3) {System.out.println("Test 15.2.2 FAIL");}
		if(!faceNodes.contains(n1)) {System.out.println("Test 15.2.3 FAIL");}
		if(!faceNodes.contains(n2)) {System.out.println("Test 15.2.4 FAIL");}
		if(!faceNodes.contains(n3)) {System.out.println("Test 15.2.5 FAIL");}
		if(!face.hasEdge(e1)){System.out.println("Test 15.2.6 FAIL");}
		if(!face.hasEdge(e2)){System.out.println("Test 15.2.7 FAIL");}	
		if(!face.hasEdge(e3)){System.out.println("Test 15.2.8 FAIL");}	  		
		fes = face.getFaceEdgeList();
		if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.5.9 FAIL");}
		
		Node n4 = new Node("n4",new Point(100,300) );
	
		Edge e4 = new Edge(n4, n3);
		Edge e5 = new Edge(n4, n2);
		...
		if(faces.size() != 3) {System.out.println("Test 15.3.1 FAIL");}	
		for(Face f: faces){
			faceNodes = f.getNodeList();
			if(f.getNodeList().size()==4){
				if(!f.existInNodeList(n1)){System.out.println("Test 15.3.2 FAIL");}	
				if(!f.existInNodeList(n2)){System.out.println("Test 15.3.3 FAIL");}	
				if(!f.existInNodeList(n3)){System.out.println("Test 15.3.4 FAIL");}	
				if(!f.existInNodeList(n4)){System.out.println("Test 15.3.5 FAIL");}		
				if(!f.hasEdge(n1,n2)){System.out.println("Test 15.3.6 FAIL");}	
				if(!f.hasEdge(n1,n3)){System.out.println("Test 15.3.7 FAIL");}	
				if(!f.hasEdge(n3,n4)){System.out.println("Test 15.3.8 FAIL");}	
				if(!f.hasEdge(n2,n4)){System.out.println("Test 15.3.9 FAIL");}
				fes = f.getFaceEdgeList();
				if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.3.9 FAIL");}
			}	
			if(f.getNodeList().size() == 3){
				if(f.existInNodeList(n4)){
					if(!f.existInNodeList(n2)){System.out.println("Test 15.3.11 FAIL");}
					if(!f.existInNodeList(n3)){System.out.println("Test 15.3.12 FAIL");}
					if(!f.hasEdge(n2,n3)){System.out.println("Test 15.3.13 FAIL");}	
					if(!f.hasEdge(n2,n4)){System.out.println("Test 15.3.14 FAIL");}	
					if(!f.hasEdge(n3,n4)){System.out.println("Test 15.3.15 FAIL");}	
					fes = f.getFaceEdgeList();
					if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.3.16 FAIL");}
					
				}
				if(f.existInNodeList(n1)){
					if(!f.existInNodeList(n2)){System.out.println("Test 15.3.17 FAIL");}
					if(!f.existInNodeList(n3)){System.out.println("Test 15.3.18 FAIL");}
					if(!f.hasEdge(n1,n2)){System.out.println("Test 15.3.19 FAIL");}	
					if(!f.hasEdge(n1,n3)){System.out.println("Test 15.3.20 FAIL");}	
					if(!f.hasEdge(n2,n3)){System.out.println("Test 15.3.21 FAIL");}	
					fes = f.getFaceEdgeList();
					if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.3.22 FAIL");}
				}
			}
		}
		Node n5 = new Node("n5", new Point(100,150));
		...
		graph.formFaces();
		faces = graph.getFaces();
		if(faces.size() != 4) {System.out.println("Test 15.4.1 FAIL");}		
		for(Face f: faces){
			faceNodes = f.getNodeList();
			if(f.getNodeList().size() == 4 && (f.existInNodeList(n1)&& f.existInNodeList(n4))){
				if(!f.existInNodeList(n1)){System.out.println("Test 15.4.2 FAIL");}	
				if(!f.existInNodeList(n2)){System.out.println("Test 15.4.3 FAIL");}	
				if(!f.existInNodeList(n3)){System.out.println("Test 15.4.4 FAIL");}	
				if(!f.existInNodeList(n4)){System.out.println("Test 15.4.5 FAIL");}	
				if(!f.hasEdge(n1,n2)){System.out.println("Test 15.4.6 FAIL");}	
				if(!f.hasEdge(n1,n3)){System.out.println("Test 15.4.7 FAIL");}	
				if(!f.hasEdge(n3,n4)){System.out.println("Test 15.4.8 FAIL");}	
				if(!f.hasEdge(n2,n4)){System.out.println("Test 15.4.9 FAIL");}
			}
			fes = f.getFaceEdgeList();
			if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.4.10 FAIL");}
		}	
		
		
		Node n6 = new Node("n6", new Point(100,250));
		Edge e8 = new Edge(n4, n6);
		...
		//graph.printFaces();
		faces = graph.getFaces();
		if(faces.size() != 4) {System.out.println("Test 15.5.1 FAIL");}		
		for(Face f: faces){
			faceNodes = f.getNodeList();
			if(f.getNodeList().size() == 5)
			{
				if(!f.existInNodeList(n1)){System.out.println("Test 15.5.2 FAIL");}	
				if(!f.existInNodeList(n2)){System.out.println("Test 15.5.3 FAIL");}	
				if(!f.existInNodeList(n3)){System.out.println("Test 15.5.4 FAIL");}	
				if(!f.existInNodeList(n4)){System.out.println("Test 15.5.5 FAIL");}		
				if(!f.existInNodeList(n6)){System.out.println("Test 15.5.6 FAIL");}	
				if(!f.hasEdge(n1,n2)){System.out.println("Test 15.5.7 FAIL");}	
				if(!f.hasEdge(n1,n3)){System.out.println("Test 15.5.8 FAIL");}	
				if(!f.hasEdge(n3,n4)){System.out.println("Test 15.5.9 FAIL");}	
				if(!f.hasEdge(n2,n4)){System.out.println("Test 15.5.10 FAIL");}	
				if(!f.hasEdge(n6,n4)){System.out.println("Test 15.5.11 FAIL");}	
				fes = f.getFaceEdgeList();
				if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.5.12 FAIL");}
			}
			else {
				fes = f.getFaceEdgeList();
				if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.5.13 FAIL");}
			}
				
		}		
		
		Node n7 = new Node("n7", new Point(120,220));
		Node n8 = new Node("n8", new Point(80,220));
		
		Edge e9 = new Edge(n7,n8);
		Edge e10 = new Edge(n6,n7);
		Edge e11 = new Edge(n6,n8);
		...
		faces = graph.getFaces();
		if(faces.size() != 5) {System.out.println("Test 15.6.1 FAIL");}		
		for(Face f: faces){
			faceNodes = f.getNodeList();
			if(f.getNodeList().size() == 8)
			{
				if(!f.existInNodeList(n1)){System.out.println("Test 15.6.2 FAIL");}	
				if(!f.existInNodeList(n2)){System.out.println("Test 15.6.3 FAIL");}	
				if(!f.existInNodeList(n3)){System.out.println("Test 15.6.4 FAIL");}	
				if(!f.existInNodeList(n4)){System.out.println("Test 15.6.5 FAIL");}		
				if(!f.existInNodeList(n5)){System.out.println("Test 15.6.6 FAIL");}	
				if(!f.existInNodeList(n6)){System.out.println("Test 15.6.7 FAIL");}	
				if(!f.existInNodeList(n7)){System.out.println("Test 15.6.8 FAIL");}	
				if(!f.existInNodeList(n8)){System.out.println("Test 15.6.9 FAIL");}	
				if(!f.hasEdge(n1,n2)){System.out.println("Test 15.6.10 FAIL");}	
				if(!f.hasEdge(n1,n3)){System.out.println("Test 15.6.11 FAIL");}	
				if(!f.hasEdge(n2,n4)){System.out.println("Test 15.6.12 FAIL");}	
				if(!f.hasEdge(n3,n4)){System.out.println("Test 15.6.13 FAIL");}	
				if(!f.hasEdge(n4,n6)){System.out.println("Test 15.6.14 FAIL");}	
				if(!f.hasEdge(n6,n7)){System.out.println("Test 15.6.15 FAIL");}	
				if(!f.hasEdge(n6,n8)){System.out.println("Test 15.6.16 FAIL");}	
				if(!f.hasEdge(n7,n8)){System.out.println("Test 15.6.17 FAIL");}					
				
				fes = f.getFaceEdgeList();
				if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.6.18 FAIL");}
			}
			else {
				fes = f.getFaceEdgeList();
				if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.6.19 FAIL");}
			}
		}		
		
		Node n9 = new Node("n9", new Point(100,50));
		Edge e12 = new Edge(n1,n9);
		
		graph.addNode(n9);
		graph.addEdge(e12);
		graph.formFaces();		
		faces = graph.getFaces();
		if(faces.size() != 5) {System.out.println("Test 15.7.1 FAIL");}
		for(Face f: faces){
			fes = f.getFaceEdgeList();
			if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.7.2 FAIL");}
		}
		
		//test isNodeInFace function
		for(Face f: faces){
			for(Node n: face.getNodeList())
			{
				if(graph.isNodeInFace(n, f)){
		...
		//test isInnerNode function
		if(graph.isInnerNode(n1,faces)){System.out.println("Test 15.7.4 FAIL");}		
		if(graph.isInnerNode(n2,faces)){System.out.println("Test 15.7.5 FAIL");}		
		if(graph.isInnerNode(n3,faces)){System.out.println("Test 15.7.6 FAIL");}		
		if(graph.isInnerNode(n4,faces)){System.out.println("Test 15.7.7 FAIL");}		
		if(!graph.isInnerNode(n5,faces)){System.out.println("Test 15.7.8 FAIL");}		
		if(!graph.isInnerNode(n6,faces)){System.out.println("Test 15.7.9 FAIL");}			
		if(!graph.isInnerNode(n7,faces)){System.out.println("Test 15.7.10 FAIL");}		
		if(!graph.isInnerNode(n8,faces)){System.out.println("Test 15.7.11 FAIL");}		
		if(graph.isInnerNode(n9,faces)){System.out.println("Test 15.7.12 FAIL");}			
		...
		if(faces.size() != 3) {System.out.println("Test 15.8.1 FAIL");}	
		
		for(Face f: faces){
			fes = f.getFaceEdgeList();
			if(!graph.isFaceEdgeCycle(fes,false)){System.out.println("Test 15.8.2 FAIL");}
		}	
		
		// testing isInnerNode function
		if(graph.isInnerNode(n2,faces)){System.out.println("Test 15.9.1 FAIL");}		
		if(graph.isInnerNode(n3,faces)){System.out.println("Test 15.9.2 FAIL");}		
		if(graph.isInnerNode(n4,faces)){System.out.println("Test 15.9.3 FAIL");}		
		if(!graph.isInnerNode(n6,faces)){System.out.println("Test 15.9.4 FAIL");}		
		if(!graph.isInnerNode(n7,faces)){System.out.println("Test 15.9.5 FAIL");}		
		if(!graph.isInnerNode(n8,faces)){System.out.println("Test 15.9.6 FAIL");}		
		...
		faces = graph.getFaces();
		if(faces.size() != 4) {System.out.println("Test 15.10.1 FAIL");}
		...
		if(graph.isInnerNode(n2,faces)){System.out.println("Test 15.10.3 FAIL");}		
		if(graph.isInnerNode(n3,faces)){System.out.println("Test 15.10.4 FAIL");}
		if(graph.isInnerNode(n4,faces)){System.out.println("Test 15.10.5 FAIL");}		
		if(!graph.isInnerNode(n6,faces)){System.out.println("Test 15.10.6 FAIL");}		
		if(!graph.isInnerNode(n7,faces)){System.out.println("Test 15.10.7 FAIL");}		
		if(!graph.isInnerNode(n8,faces)){System.out.println("Test 15.10.8 FAIL");}
	...
	public static void testD(){
		...
		retD = pjr.graph.Util.lineAngle(p1,p2);
		...
		retD = pjr.graph.Util.lineAngle(pd1,pd2);
		...
		retD = pjr.graph.Util.lineAngle(pd1,pd2);
		if(pjr.graph.Util.round(Math.toDegrees(retD),0) != 30.0) {System.out.println("Test 16.1.18 FAIL");}	  		

		p1 = new Point(200,100);
		p2 = new Point(200,200);
		p3 = new Point(100,200);
		retD = pjr.graph.Util.angle(p1,p2,p3);
		...
		retD = pjr.graph.Util.angle(pd1,pd2,pd3);
		...
		retD = pjr.graph.Util.angle(pd1,pd2,pd3);
		if(pjr.graph.Util.round(Math.toDegrees(retD),0) != 30.0) {System.out.println("Test 16.2.21 FAIL");}

		if(pjr.graph.Util.round(29.51,0) != 30.0) {System.out.println("Test 16.3.1 FAIL");}
		if(pjr.graph.Util.round(30.49,0) != 30.0) {System.out.println("Test 16.3.2 FAIL");}
		if(pjr.graph.Util.round(29.51,1) != 29.5) {System.out.println("Test 16.3.3 FAIL");}
		if(pjr.graph.Util.round(30.49,1) != 30.5) {System.out.println("Test 16.3.4 FAIL");}
		if(pjr.graph.Util.round(0.5,0) != 0) {System.out.println("Test 16.3.5 FAIL");}
		if(pjr.graph.Util.round(-0.5,0) != 0) {System.out.println("Test 16.3.6 FAIL");}
		if(pjr.graph.Util.round(0.111111,0) != 0) {System.out.println("Test 16.3.7 FAIL");}
		if(pjr.graph.Util.round(0.111111,1) != 0.1) {System.out.println("Test 16.3.8 FAIL");}
		if(pjr.graph.Util.round(0.111111,2) != 0.11) {System.out.println("Test 16.3.9 FAIL");}
		if(pjr.graph.Util.round(0.111111,3) != 0.111) {System.out.println("Test 16.3.10 FAIL");}
		
		if(pjr.graph.Util.convertToInteger(0.1) != 0) {System.out.println("Test 16.3.11 FAIL");}
		if(pjr.graph.Util.convertToInteger(0.9) != 1) {System.out.println("Test 16.3.12 FAIL");}
		if(pjr.graph.Util.convertToInteger(10.51) != 11) {System.out.println("Test 16.3.13 FAIL");}
		if(pjr.graph.Util.convertToInteger(20.49) != 20) {System.out.println("Test 16.3.14 FAIL");}
		if(pjr.graph.Util.convertToInteger(-1.2) != -1) {System.out.println("Test 16.3.15 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(0,0);
		if(pjr.graph.Util.distance(p1,p2) != 0) {System.out.println("Test 16.4.1 FAIL");}
		p1 = new Point(0,0);
		p2 = new Point(0,10);
		if(pjr.graph.Util.distance(p1,p2) != 10) {System.out.println("Test 16.4.2 FAIL");}
		p1 = new Point(0,10);
		p2 = new Point(0,0);
		if(pjr.graph.Util.distance(p1,p2) != 10) {System.out.println("Test 16.4.3 FAIL");}
		p1 = new Point(-30,10);
		p2 = new Point(10,10);
		if(pjr.graph.Util.distance(p1,p2) != 40) {System.out.println("Test 16.4.4 FAIL");}
		p1 = new Point(100,100);
		p2 = new Point(103,96);
		if(pjr.graph.Util.distance(p1,p2) != 5) {System.out.println("Test 16.4.5 FAIL");}

		pd1 = new Point2D.Double(0,0);
		pd2 = new Point2D.Double(0,0);
		if(pjr.graph.Util.distance(pd1,pd2) != 0) {System.out.println("Test 16.4.6 FAIL");}
		pd1 = new Point2D.Double(0,0);
		pd2 = new Point2D.Double(0,10);
		if(pjr.graph.Util.distance(pd1,pd2) != 10) {System.out.println("Test 16.4.7 FAIL");}
		pd1 = new Point2D.Double(0,10);
		pd2 = new Point2D.Double(0,0);
		if(pjr.graph.Util.distance(pd1,pd2) != 10) {System.out.println("Test 16.4.8 FAIL");}
		pd1 = new Point2D.Double(-30,10);
		pd2 = new Point2D.Double(10,10);
		if(pjr.graph.Util.distance(pd1,pd2) != 40) {System.out.println("Test 16.4.9 FAIL");}
		pd1 = new Point2D.Double(100,100);
		pd2 = new Point2D.Double(103,96);
		if(pjr.graph.Util.distance(pd1,pd2) != 5) {System.out.println("Test 16.4.10 FAIL");}
		pd1 = new Point2D.Double(100,100);
		pd2 = new Point2D.Double(100.1,100);
		if(pjr.graph.Util.round(pjr.graph.Util.distance(pd1,pd2),1) != 0.1) {System.out.println("Test 16.4.11 FAIL");}
		
		x1 = 0;
		y1 = 0;
		x2 = 0;
		y2 = 0;
		if(pjr.graph.Util.distance(x1,y1,x2,y2) != 0) {System.out.println("Test 16.4.12 FAIL");}
		x1 = 0;
		y1 = -100;
		x2 = 0;
		y2 = 0;
		if(pjr.graph.Util.distance(x1,y1,x2,y2) != 100) {System.out.println("Test 16.4.13 FAIL");}
		x1 = 0;
		y1 = 0;
		x2 = 50;
		y2 = 0;
		if(pjr.graph.Util.distance(x1,y1,x2,y2) != 50) {System.out.println("Test 16.4.14 FAIL");}
		x1 = -4;
		y1 = 3;
		x2 = 0;
		y2 = 0;
		if(pjr.graph.Util.distance(x1,y1,x2,y2) != 5) {System.out.println("Test 16.4.15 FAIL");}
		x1 = 1;
		y1 = 2;
		x2 = 3;
		y2 = 4;
		if(pjr.graph.Util.distance(x1,y1,x2,y2) != Math.sqrt(8)) {System.out.println("Test 16.4.16 FAIL");}

		xd1 = 0.0;
		yd1 = 0.0;
		xd2 = 0.0;
		yd2 = 0.0;
		if(pjr.graph.Util.distance(xd1,yd1,xd2,yd2) != 0) {System.out.println("Test 16.4.17 FAIL");}

		xd1 = 0.0;
		yd1 = 0.0;
		xd2 = 0.0;
		yd2 = 0.1;
		if(pjr.graph.Util.distance(xd1,yd1,xd2,yd2) != 0.1) {System.out.println("Test 16.4.18 FAIL");}

		xd1 = -0.3;
		yd1 = 0.0;
		xd2 = 0.0;
		yd2 = 0.0;
		if(pjr.graph.Util.distance(xd1,yd1,xd2,yd2) != 0.3) {System.out.println("Test 16.4.19 FAIL");}

		xd1 = 0.0;
		yd1 = 4.0;
		xd2 = -3.0;
		yd2 = 0.0;
		if(pjr.graph.Util.distance(xd1,yd1,xd2,yd2) != 5.0) {System.out.println("Test 16.4.20 FAIL");}

		xd1 = 1.0;
		yd1 = -1.0;
		xd2 = -2.0;
		yd2 = 3.0;
		if(pjr.graph.Util.distance(xd1,yd1,xd2,yd2) != 5.0) {System.out.println("Test 16.4.21 FAIL");}

		xd1 = 0.0;
		yd1 = 0.0;
		xd2 = 1.0;
		yd2 = 1.0;
		if(pjr.graph.Util.distance(xd1,yd1,xd2,yd2) != Math.sqrt(2)) {System.out.println("Test 16.4.22 FAIL");}
		...
		if(!pjr.graph.Util.intersectionPointOfTwoLines(p1,p2,p3,p4).equals(new Point(150,100))) {System.out.println("Test 16.5.1 FAIL");}
		p1 = new Point(-100,0);
		p2 = new Point(100,0);
		p3 = new Point(0,0);
		p4 = new Point(0,200);
		if(!pjr.graph.Util.intersectionPointOfTwoLines(p1,p2,p3,p4).equals(new Point(0,0))) {System.out.println("Test 16.5.2 FAIL");}
		p1 = new Point(-100,-100);
		p2 = new Point(100,100);
		p3 = new Point(-100,100);
		p4 = new Point(100,-100);
		if(!pjr.graph.Util.intersectionPointOfTwoLines(p1,p2,p3,p4).equals(new Point(0,0))) {System.out.println("Test 16.5.3 FAIL");}
		p1 = new Point(200,200);
		p2 = new Point(100,100);
		p3 = new Point(-100,100);
		p4 = new Point(100,-100);
		if(!pjr.graph.Util.intersectionPointOfTwoLines(p1,p2,p3,p4).equals(new Point(0,0))) {System.out.println("Test 16.5.4 FAIL");}
		p1 = new Point(0,0);
		p2 = new Point(0,100);
		p3 = new Point(100,0);
		p4 = new Point(100,100);
		if(pjr.graph.Util.intersectionPointOfTwoLines(p1,p2,p3,p4) != null) {System.out.println("Test 16.5.4a FAIL");}
		p1 = new Point(0,0);
		p2 = new Point(100,100);
		p3 = new Point(0,100);
		p4 = new Point(100,200);
		if(pjr.graph.Util.intersectionPointOfTwoLines(p1,p2,p3,p4) != null) {System.out.println("Test 16.5.4b FAIL");}
		...
		if(!pjr.graph.Util.intersectionPointOfTwoLines(pd1,pd2,pd3,pd4).equals(new Point2D.Double(0.15,0.1))) {System.out.println("Test 16.5.5 FAIL");}
		pd1 = new Point2D.Double(-0.1,0);
		pd2 = new Point2D.Double(0.1,0);
		pd3 = new Point2D.Double(0,0);
		pd4 = new Point2D.Double(0,0.2);
		if(!pjr.graph.Util.intersectionPointOfTwoLines(pd1,pd2,pd3,pd4).equals(new Point2D.Double(0,0))) {System.out.println("Test 16.5.6 FAIL");}
		pd1 = new Point2D.Double(-0.1,-0.1);
		pd2 = new Point2D.Double(0.1,0.1);
		pd3 = new Point2D.Double(-0.1,0.1);
		pd4 = new Point2D.Double(0.1,-0.1);
		if(!pjr.graph.Util.intersectionPointOfTwoLines(pd1,pd2,pd3,pd4).equals(new Point2D.Double(0,0))) {System.out.println("Test 16.5.7 FAIL");}
		pd1 = new Point2D.Double(0.2,0.2);
		pd2 = new Point2D.Double(0.1,0.1);
		pd3 = new Point2D.Double(-0.1,0.1);
		pd4 = new Point2D.Double(0.1,-0.1);
		if(!pjr.graph.Util.intersectionPointOfTwoLines(pd1,pd2,pd3,pd4).equals(new Point2D.Double(0,0))) {System.out.println("Test 16.5.8 FAIL");}
		pd1 = new Point2D.Double(0,0);
		pd2 = new Point2D.Double(0,0.1);
		pd3 = new Point2D.Double(0.1,0);
		pd4 = new Point2D.Double(0.1,0.1);
		if(pjr.graph.Util.intersectionPointOfTwoLines(pd1,pd2,pd3,pd4)!= null) {System.out.println("Test 16.5.9 FAIL");}
		pd1 = new Point2D.Double(0,0);
		pd2 = new Point2D.Double(0.1,0);
		...
		p1 = new Point(0,200);
		p2 = new Point(200,0);
		if(!pjr.graph.Util.perpendicularPoint(p0,p1,p2).equals(new Point(100,100))) {System.out.println("Test 16.6.1 FAIL");}
		p0 = new Point(100,100);
		p1 = new Point(300,200);
		p2 = new Point(200,200);
		if(!pjr.graph.Util.perpendicularPoint(p0,p1,p2).equals(new Point(100,200))) {System.out.println("Test 16.6.2 FAIL");}
		p0 = new Point(-100,-100);
		p1 = new Point(-300,-200);
		p2 = new Point(-200,-200);
		if(!pjr.graph.Util.perpendicularPoint(p0,p1,p2).equals(new Point(-100,-200))) {System.out.println("Test 16.6.3 FAIL");}
		p0 = new Point(100,100);
		p1 = new Point(200,300);
		p2 = new Point(200,200);
		if(!pjr.graph.Util.perpendicularPoint(p0,p1,p2).equals(new Point(200,100))) {System.out.println("Test 16.6.4 FAIL");}
		p0 = new Point(-100,-100);
		p1 = new Point(-200,-300);
		p2 = new Point(-200,-200);
		if(!pjr.graph.Util.perpendicularPoint(p0,p1,p2).equals(new Point(-200,-100))) {System.out.println("Test 16.6.5 FAIL");}
		p0 = new Point(100,100);
		p1 = new Point(1,200);
		p2 = new Point(-1,200);
		if(!pjr.graph.Util.perpendicularPoint(p0,p1,p2).equals(new Point(100,200))) {System.out.println("Test 16.6.6 FAIL");}
		p0 = new Point(150,-150);
		p1 = new Point(200,-200);
		p2 = new Point(100,-100);
		if(!pjr.graph.Util.perpendicularPoint(p0,p1,p2).equals(new Point(150,-150))) {System.out.println("Test 16.6.7 FAIL");}

		pd0 = new Point2D.Double(0.2,0.2);
		pd1 = new Point2D.Double(0,0.2);
		pd2 = new Point2D.Double(0.2,0);
		if(!pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).equals(new Point2D.Double(0.1,0.1))) {System.out.println("Test 16.6.8 FAIL");}
		pd0 = new Point2D.Double(0.1,0.1);
		pd1 = new Point2D.Double(0.3,0.2);
		pd2 = new Point2D.Double(0.2,0.2);
		if(!pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).equals(new Point2D.Double(0.1,0.2))) {System.out.println("Test 16.6.9 FAIL");}
		pd0 = new Point2D.Double(-0.1,-0.1);
		pd1 = new Point2D.Double(-0.3,-0.2);
		pd2 = new Point2D.Double(-0.2,-0.2);
		if(!pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).equals(new Point2D.Double(-0.1,-0.2))) {System.out.println("Test 16.6.10 FAIL");}
		pd0 = new Point2D.Double(0.15,0.1);
		pd1 = new Point2D.Double(0.2,0.3);
		pd2 = new Point2D.Double(0.2,0.2);
		if(pjr.graph.Util.round(pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).x,1) != 0.2 || pjr.graph.Util.round(pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).y,1) != 0.1) {System.out.println("Test 16.6.11 FAIL");}
		pd0 = new Point2D.Double(-0.15,-0.1);
		pd1 = new Point2D.Double(-0.2,-0.3);
		pd2 = new Point2D.Double(-0.2,-0.2);
		if(pjr.graph.Util.round(pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).x,1) != -0.2 || pjr.graph.Util.round(pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).y,1) != -0.1) {System.out.println("Test 16.6.12 FAIL");}
		pd0 = new Point2D.Double(100,100);
		pd1 = new Point2D.Double(0.1,200);
		pd2 = new Point2D.Double(-0.1,200);
		if(!pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).equals(new Point2D.Double(100.0,200.0))) {System.out.println("Test 16.6.13 FAIL");}
		pd0 = new Point2D.Double(0.15,-0.15);
		pd1 = new Point2D.Double(0.2,-0.2);
		pd2 = new Point2D.Double(0.1,-0.1);
		if(!pjr.graph.Util.perpendicularPoint(pd0,pd1,pd2).equals(new Point2D.Double(0.15,-0.15))) {System.out.println("Test 16.6.14 FAIL");}
		
		
		p0 = new Point(100,100);
		p1 = new Point(0,0);
		p2 = new Point(200,200);
		if(!pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.1 FAIL");}

		p0 = new Point(300,300);
		p1 = new Point(0,0);
		p2 = new Point(200,200);
		if(pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.2 FAIL");}

		p0 = new Point(100,100);
		p1 = new Point(200,200);
		p2 = new Point(0,0);
		if(!pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.3 FAIL");}

		p0 = new Point(300,300);
		p1 = new Point(20,200);
		p2 = new Point(0,0);
		if(pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.4 FAIL");}

		p0 = new Point(100,100);
		p1 = new Point(0,200);
		p2 = new Point(200,0);
		if(!pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.5 FAIL");}

		p0 = new Point(300,300);
		p1 = new Point(0,200);
		p2 = new Point(200,0);
		if(pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.6 FAIL");}

		p0 = new Point(100,100);
		p1 = new Point(200,0);
		p2 = new Point(0,200);
		if(!pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.7 FAIL");}

		p0 = new Point(300,300);
		p1 = new Point(200,0);
		p2 = new Point(0,200);
		if(pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.8 FAIL");}

		p0 = new Point(200,0);
		p1 = new Point(200,0);
		p2 = new Point(0,200);
		if(!pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.9 FAIL");}

		p0 = new Point(200,0);
		p1 = new Point(0,200);
		p2 = new Point(200,0);
		if(!pjr.graph.Util.pointIsWithinBounds(p0,p1,p2)) {System.out.println("Test 16.7.10 FAIL");}

		p1 = new Point(0,0);
		p2 = new Point(0,200);
		if(!pjr.graph.Util.midPoint(p1,p2).equals(new Point(0,100))) {System.out.println("Test 16.8.1 FAIL");}
		if(!pjr.graph.Util.midPoint(p2,p1).equals(new Point(0,100))) {System.out.println("Test 16.8.2 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(0,-200);
		if(!pjr.graph.Util.midPoint(p1,p2).equals(new Point(0,-100))) {System.out.println("Test 16.8.3 FAIL");}
		if(!pjr.graph.Util.midPoint(p2,p1).equals(new Point(0,-100))) {System.out.println("Test 16.8.4 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(400,200);
		if(!pjr.graph.Util.midPoint(p1,p2).equals(new Point(200,100))) {System.out.println("Test 16.8.5 FAIL");}
		if(!pjr.graph.Util.midPoint(p2,p1).equals(new Point(200,100))) {System.out.println("Test 16.8.6 FAIL");}
		
		pd1 = new Point2D.Double(-0.2,-0.3);
		pd2 = new Point2D.Double(0.2,0.3);
		if(!pjr.graph.Util.midPoint(pd1,pd2).equals(new Point2D.Double(0.0,0.0))) {System.out.println("Test 16.8.7 FAIL");}
		if(!pjr.graph.Util.midPoint(pd2,pd1).equals(new Point2D.Double(0.0,0.0))) {System.out.println("Test 16.8.8 FAIL");}

		pd1 = new Point2D.Double(0.2,0.3);
		pd2 = new Point2D.Double(0.4,0.9);
		if(pjr.graph.Util.round(pjr.graph.Util.midPoint(pd1,pd2).getX(),2) != 0.3) {System.out.println("Test 16.8.9 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.midPoint(pd2,pd1).getX(),2) != 0.3) {System.out.println("Test 16.8.10 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.midPoint(pd1,pd2).getY(),2) != 0.6) {System.out.println("Test 16.8.11 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.midPoint(pd2,pd1).getY(),2) != 0.6) {System.out.println("Test 16.8.12 FAIL");}

		p1 = new Point(1,1);
		p2 = new Point(1,11);
		if(pjr.graph.Util.betweenPoints(p1,p2,0.1).x != 1) {System.out.println("Test 16.8.13 FAIL");}
		if(pjr.graph.Util.betweenPoints(p2,p1,0.1).x != 1) {System.out.println("Test 16.8.14 FAIL");}
		if(pjr.graph.Util.betweenPoints(p1,p2,0.1).y != 2) {System.out.println("Test 16.8.15 FAIL");}
		if(pjr.graph.Util.betweenPoints(p2,p1,0.1).y != 10) {System.out.println("Test 16.8.16 FAIL");}

		p1 = new Point(0,0);
		p2 = new Point(-8,8);
		if(pjr.graph.Util.betweenPoints(p1,p2,0.25).x != -2) {System.out.println("Test 16.8.17 FAIL");}
		if(pjr.graph.Util.betweenPoints(p2,p1,0.25).x != -6) {System.out.println("Test 16.8.18 FAIL");}
		if(pjr.graph.Util.betweenPoints(p1,p2,0.25).y != 2) {System.out.println("Test 16.8.19 FAIL");}
		if(pjr.graph.Util.betweenPoints(p2,p1,0.25).y != 6) {System.out.println("Test 16.8.20 FAIL");}
		
		pd1 = new Point2D.Double(0.20,0.10);
		pd2 = new Point2D.Double(0.30,-0.10);
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd1,pd2,0.2).getX(),2) != 0.22) {System.out.println("Test 16.8.21 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd2,pd1,0.2).getX(),2) != 0.28) {System.out.println("Test 16.8.22 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd1,pd2,0.2).getY(),2) != 0.06) {System.out.println("Test 16.8.23 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd2,pd1,0.2).getY(),2) != -0.06) {System.out.println("Test 16.8.24 FAIL");}

		pd1 = new Point2D.Double(-0.20,0.30);
		pd2 = new Point2D.Double(-0.20,0.30);
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd1,pd2,0.2).getX(),2) != -0.2) {System.out.println("Test 16.8.25 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd2,pd1,0.2).getX(),2) != -0.2) {System.out.println("Test 16.8.26 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd1,pd2,0.2).getY(),2) != 0.3) {System.out.println("Test 16.8.27 FAIL");}
		if(pjr.graph.Util.round(pjr.graph.Util.betweenPoints(pd2,pd1,0.2).getY(),2) != 0.3) {System.out.println("Test 16.8.28 FAIL");}

		p1 = new Point(0,0);
		p2 = new Point(100,0);
		p3 = new Point(100,100);
		p4 = new Point(50,50);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4)!= Math.toRadians(90)) {System.out.println("Test 16.9.1 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4)!= Math.toRadians(90)) {System.out.println("Test 16.9.2 FAIL");}

		p4 = new Point(-250,200);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4)!= Math.toRadians(90)) {System.out.println("Test 16.9.3 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4)!= Math.toRadians(90)) {System.out.println("Test 16.9.4 FAIL");}

		p4 = new Point(-50,-50);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4)!= Math.toRadians(270)) {System.out.println("Test 16.9.5 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4)!= Math.toRadians(270)) {System.out.println("Test 16.9.6 FAIL");}
		
		p4 = new Point(-250,-250);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4)!= Math.toRadians(270)) {System.out.println("Test 16.9.7 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4)!= Math.toRadians(270)) {System.out.println("Test 16.9.8 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(100,0);
		p3 = new Point(200,0);
		p4 = new Point(50,50);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4)!= Math.toRadians(180)) {System.out.println("Test 16.9.9 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4)!= Math.toRadians(180)) {System.out.println("Test 16.9.10 FAIL");}

		p4 = new Point(-250,-250);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4)!= Math.toRadians(180)) {System.out.println("Test 16.9.11 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4)!= Math.toRadians(180)) {System.out.println("Test 16.9.12 FAIL");}
		
		p1 = new Point(205,188);
		p2 = new Point(321,191);
		p3 = new Point(188,65);
		p4 = new Point(333,201);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) < Math.toRadians(180)) {System.out.println("Test 16.9.13 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) < Math.toRadians(180)) {System.out.println("Test 16.9.14 FAIL");}
		
		p1 = new Point(50,0);
		p2 = new Point(0,0);
		p3 = new Point(50,50);
		p4 = new Point(100,200);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) != Math.toRadians(315)) {System.out.println("Test 16.9.15 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) != Math.toRadians(315)) {System.out.println("Test 16.9.16 FAIL");}

		p1 = new Point(50,0);
		p2 = new Point(0,0);
		p3 = new Point(50,50);
		p4 = new Point(200,100);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) != Math.toRadians(45)) {System.out.println("Test 16.9.17 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) != Math.toRadians(45)) {System.out.println("Test 16.9.18 FAIL");}
		
		p1 = new Point(-50,0);
		p2 = new Point(0,0);
		p3 = new Point(-50,-50);
		p4 = new Point(-100,-200);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) < Math.toRadians(315)) {System.out.println("Test 16.9.19 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) < Math.toRadians(315)) {System.out.println("Test 16.9.20 FAIL");}
		
		p1 = new Point(-50,0);
		p2 = new Point(0,0);
		p3 = new Point(-50,-50);
		p4 = new Point(-200,-100);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) < Math.toRadians(45)) {System.out.println("Test 16.9.21 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) < Math.toRadians(45)) {System.out.println("Test 16.9.22 FAIL");}
		
		p1 = new Point(0,50);
		p2 = new Point(0,0);
		p3 = new Point(50,50);
		p4 = new Point(200,100);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) != Math.toRadians(315)) {System.out.println("Test 16.9.23 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) != Math.toRadians(315)) {System.out.println("Test 16.9.24 FAIL");}
		
		p1 = new Point(0,50);
		p2 = new Point(0,0);
		p3 = new Point(50,50);
		p4 = new Point(100,200);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) != Math.toRadians(45)) {System.out.println("Test 16.9.25 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) != Math.toRadians(45)) {System.out.println("Test 16.9.26 FAIL");}
		
		p1 = new Point(0,-50);
		p2 = new Point(0,0);
		p3 = new Point(-50,-50);
		p4 = new Point(-200,-100);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) != Math.toRadians(315)) {System.out.println("Test 16.9.27 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) != Math.toRadians(315)) {System.out.println("Test 16.9.28 FAIL");}
		
		p1 = new Point(0,-50);
		p2 = new Point(0,0);
		p3 = new Point(-50,-50);
		p4 = new Point(-100,-200);
		if(pjr.graph.Util.getRelativeAngle(p1,p2,p3,p4) != Math.toRadians(45)) {System.out.println("Test 16.9.29 FAIL");}
		if(pjr.graph.Util.getRelativeAngle(p3,p2,p1,p4) != Math.toRadians(45)) {System.out.println("Test 16.9.30 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(0,10);
		p3 = new Point(5,0);
		p4 = new Point(5,10);
		if(!pjr.graph.Util.linesParallel(p1,p2,p3,p4)) {System.out.println("Test 16.10.1 FAIL");}
		if(!pjr.graph.Util.linesParallel(p3,p4,p2,p1)) {System.out.println("Test 16.10.2 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(10,10);
		p3 = new Point(50,100);
		p4 = new Point(100,150);
		if(!pjr.graph.Util.linesParallel(p1,p2,p3,p4)) {System.out.println("Test 16.10.3 FAIL");}
		if(!pjr.graph.Util.linesParallel(p3,p4,p2,p1)) {System.out.println("Test 16.10.4 FAIL");}
		if(pjr.graph.Util.linesParallel(p1,p3,p2,p4)) {System.out.println("Test 16.10.5 FAIL");}
		if(pjr.graph.Util.linesParallel(p2,p4,p4,p1)) {System.out.println("Test 16.10.6 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(10,0);
		p3 = new Point(5,0);
		p4 = new Point(5,10);
		if(pjr.graph.Util.linesParallel(p1,p2,p3,p4)) {System.out.println("Test 16.10.7 FAIL");}
		if(pjr.graph.Util.linesParallel(p3,p4,p2,p1)) {System.out.println("Test 16.10.8 FAIL");}
		
		p1 = new Point(0,0);
		p2 = new Point(10,10);
		p3 = new Point(50,100);
		p4 = new Point(100,151);
		if(pjr.graph.Util.linesParallel(p1,p2,p3,p4)) {System.out.println("Test 16.10.9 FAIL");}
		if(pjr.graph.Util.linesParallel(p3,p4,p2,p1)) {System.out.println("Test 16.10.10 FAIL");}
		
		p1 = new Point(1,10);
		p2 = new Point(2,20);
		p3 = new Point(10,100);
		p4 = new Point(2,200);
		if(pjr.graph.Util.linesParallel(p2,p1,p3,p4)) {System.out.println("Test 16.10.11 FAIL");}
		if(pjr.graph.Util.linesParallel(p3,p4,p1,p2)) {System.out.println("Test 16.10.12 FAIL");}
		
		p1 = new Point(2,1);
		p2 = new Point(14,12);
		p3 = new Point(65,6);
		p4 = new Point(45,100);
		if(pjr.graph.Util.linesParallel(p1,p2,p3,p4)) {System.out.println("Test 16.10.13 FAIL");}
		if(pjr.graph.Util.linesParallel(p3,p4,p2,p1)) {System.out.println("Test 16.10.14 FAIL");}
		
		p1 = new Point(339,220);
		p2 = new Point(362,234);
		p3 = new Point(339,220);
		p4 = new Point(316,206);
		if(!pjr.graph.Util.linesParallel(p1,p2,p3,p4)) {System.out.println("Test 16.10.15 FAIL");}
		if(!pjr.graph.Util.linesParallel(p4,p3,p1,p2)) {System.out.println("Test 16.10.16 FAIL");}
		
		
		if(!pjr.graph.Util.reverseString("").equals("")) {System.out.println("Test 16.11.1 FAIL");}
		if(!pjr.graph.Util.reverseString("a").equals("a")) {System.out.println("Test 16.11.12 FAIL");}
		if(!pjr.graph.Util.reverseString("ab").equals("ba")) {System.out.println("Test 16.11.13 FAIL");}
		if(!pjr.graph.Util.reverseString("bab").equals("bab")) {System.out.println("Test 16.11.14 FAIL");}
		if(!pjr.graph.Util.reverseString("abcde").equals("edcba")) {System.out.println("Test 16.11.15 FAIL");}
		if(!pjr.graph.Util.reverseString("aaabbb").equals("bbbaaa")) {System.out.println("Test 16.11.16 FAIL");}

		p1 = new Point(100,100);
		p2 = new Point(200,200);
		p3 = new Point(150,150);
		if(pjr.graph.Util.pointLineDistance(p3, p1, p2) != 0.0) {System.out.println("Test 16.12.1 FAIL");}
		if(pjr.graph.Util.pointLineDistance(p3, p2, p1) != 0.0) {System.out.println("Test 16.12.2 FAIL");}
		
		p1 = new Point(100,100);
		p2 = new Point(200,100);
		p3 = new Point(130,100);
		if(pjr.graph.Util.pointLineDistance(p3, p1, p2) != 0.0) {System.out.println("Test 16.12.3 FAIL");}
		if(pjr.graph.Util.pointLineDistance(p3, p2, p1) != 0.0) {System.out.println("Test 16.12.4 FAIL");}
		
		p1 = new Point(100,100);
		p2 = new Point(200,100);
		p3 = new Point(130,110);

		if(pjr.graph.Util.pointLineDistance(p3, p1, p2) != 10.0) {System.out.println("Test 16.12.5 FAIL");}
		if(pjr.graph.Util.pointLineDistance(p3, p2, p1) != 10.0) {System.out.println("Test 16.12.6 FAIL");}
		
		p1 = new Point(100,100);
		p2 = new Point(200,100);
		p3 = new Point(70,140);
		if(pjr.graph.Util.pointLineDistance(p3, p1, p2) != 50.0) {System.out.println("Test 16.12.7 FAIL");}
		if(pjr.graph.Util.pointLineDistance(p3, p2, p1) != 50.0) {System.out.println("Test 16.12.8 FAIL");}
		
		p1 = new Point(100,100);
		p2 = new Point(200,100);
		p3 = new Point(300,100);
		if(pjr.graph.Util.pointLineDistance(p3, p1, p2) != 100.0) {System.out.println("Test 16.12.7 FAIL");}
		if(pjr.graph.Util.pointLineDistance(p3, p2, p1) != 100.0) {System.out.println("Test 16.12.8 FAIL");}
		...
		ArrayList<Node> faceNodes;
		ArrayList<ArrayList<Face>> connectedFaces;
		...
		g = new Graph();
		g.formFaces();
		connectedFaces = g.findConnectedFaces();
		if(connectedFaces.size() != 0) {System.out.println("Test 17.1.1 FAIL");}

		g = new Graph();
		n1 = new Node("n1",new Point(100,100));
		n2 = new Node("n2",new Point(150,200));
		n3 = new Node("n3",new Point(50,200));
		g.addNode(n1);
		g.addNode(n2);
		g.addNode(n3);
		g.addEdge(new Edge(n1,n2));
		...
		g.formFaces();
		connectedFaces = g.findConnectedFaces();
		if(connectedFaces.size() != 1) {System.out.println("Test 17.1.2 FAIL");}
		faceList = connectedFaces.get(0);
		if(faceList.size() != 2) {System.out.println("Test 17.1.3 FAIL");}
		face = faceList.get(0);
		faceNodes = face.getNodeList();
		if(faceNodes.size() != 3) {System.out.println("Test 17.1.4 FAIL");}
		if(!faceNodes.contains(n1)) {System.out.println("Test 17.1.5 FAIL");}
		if(!faceNodes.contains(n2)) {System.out.println("Test 17.1.6 FAIL");}
		if(!faceNodes.contains(n3)) {System.out.println("Test 17.1.7 FAIL");}

		g = new Graph();
		n1 = new Node("n1",new Point(100,100));
		n2 = new Node("n2",new Point(150,200));
		n3 = new Node("n3",new Point(50,200));
		n4 = new Node("n5",new Point(400,400));
		n5 = new Node("n5",new Point(500,400));
		n6 = new Node("n6",new Point(400,500));
		g.addNode(n1);
		g.addNode(n2);
		g.addNode(n3);
		g.addNode(n4);
		...
		g.addEdge(new Edge(n6,n4));
		g.formFaces();
		connectedFaces = g.findConnectedFaces();
		if(connectedFaces.size() != 2) {System.out.println("Test 17.1.8 FAIL");}
		faceList = connectedFaces.get(0);
		if(faceList.size() != 2) {System.out.println("Test 17.1.9 FAIL");}
		faceList = connectedFaces.get(1);
		if(faceList.size() != 2) {System.out.println("Test 17.1.10 FAIL");}

		g = new Graph();
		n1 = new Node("n1",new Point(100,100));
		n2 = new Node("n2",new Point(150,200));
		n3 = new Node("n3",new Point(50,200));
		n4 = new Node("n4",new Point(0,0));
		n5 = new Node("n5",new Point(0,1200));
		n6 = new Node("n6",new Point(1200,0));
		g.addNode(n1);
		g.addNode(n2);
		g.addNode(n3);
		g.addNode(n4);
		...
		g.formFaces();
		connectedFaces = g.findConnectedFaces();
		if(connectedFaces.size() != 2) {System.out.println("Test 17.1.11 FAIL");}
		faceList = connectedFaces.get(0);
		if(faceList.size() != 2) {System.out.println("Test 17.1.12 FAIL");}
		faceList = connectedFaces.get(1);
		if(faceList.size() != 2) {System.out.println("Test 17.1.13 FAIL");}

		g = new Graph();
		n1 = new Node("n1",new Point(200,200));
		n2 = new Node("n2",new Point(200,300));
		n3 = new Node("n3",new Point(300,200));
		n4 = new Node("n4",new Point(400,400));
		n5 = new Node("n5",new Point(400,500));
		n6 = new Node("n6",new Point(500,400));
		n7 = new Node("n7",new Point(10,10));
		n8 = new Node("n8",new Point(100,10));
		n9 = new Node("n9",new Point(10,100));
		g.addNode(n1);
		g.addNode(n2);
		g.addNode(n3);
		g.addNode(n4);
		...
		g.addEdge(new Edge(n5,n6));
		g.addEdge(new Edge(n6,n4));
		g.addEdge(new Edge(n7,n8));
		g.addEdge(new Edge(n8,n9));
		g.addEdge(new Edge(n9,n7));
		g.formFaces();
		connectedFaces = g.findConnectedFaces();
		if(connectedFaces.size() != 3) {System.out.println("Test 17.1.14 FAIL");}
		faceList = connectedFaces.get(0);
		if(faceList.size() != 2) {System.out.println("Test 17.1.15 FAIL");}
		faceList = connectedFaces.get(1);
		if(faceList.size() != 2) {System.out.println("Test 17.1.16 FAIL");}
		faceList = connectedFaces.get(2);
		if(faceList.size() != 2) {System.out.println("Test 17.1.17 FAIL");}
		
		g.addEdge(new Edge(n2,n9));
		g.addEdge(new Edge(n3,n8));
		g.formFaces();
		connectedFaces = g.findConnectedFaces();
		if(connectedFaces.size() != 2) {System.out.println("Test 17.1.18 FAIL");}
		sizeList = new ArrayList<Integer>();
		for(ArrayList<Face> fl : connectedFaces) {
			sizeList.add(fl.size());
		}
		Collections.sort(sizeList);
		if(sizeList.get(0) != 2) {System.out.println("Test 17.1.19 FAIL");}
		if(sizeList.get(1) != 4) {System.out.println("Test 17.1.20 FAIL");}
	...
	public static void testE() {
		...
		graph.formFaces();		
		graph.getFaces();
		Face f = graph.getOuterFace();		
		if(!f.hasNode(n1)) {System.out.println("Test 18.1.1 FAIL");}
		if(!f.hasNode(n2)) {System.out.println("Test 18.1.2 FAIL");}	
		if(!f.hasNode(n3)) {System.out.println("Test 18.1.3 FAIL");}		
		if(!f.hasEdge(e1)) {System.out.println("Test 18.1.4 FAIL");}
		if(!f.hasEdge(e2)) {System.out.println("Test 18.1.5 FAIL");}	
		if(!f.hasEdge(e3)) {System.out.println("Test 18.1.6 FAIL");}	
		...
		graph.formFaces();		
		graph.getFaces();			
		f = graph.getOuterFace();		
		if(!f.hasNode(n1)) {System.out.println("Test 18.2.1 FAIL");}
		if(!f.hasNode(n2)) {System.out.println("Test 18.2.2 FAIL");}	
		if(!f.hasNode(n3)) {System.out.println("Test 18.2.3 FAIL");}
		if(!f.hasNode(n4)) {System.out.println("Test 18.2.4 FAIL");}		
		if(!f.hasEdge(e1)) {System.out.println("Test 18.2.5 FAIL");}
		if(f.hasEdge(e2)) {System.out.println("Test 18.2.6 FAIL");}		
		if(!f.hasEdge(e3)) {System.out.println("Test 18.2.7 FAIL");}	
		if(!f.hasEdge(e4)) {System.out.println("Test 18.2.8 FAIL");}	
		if(!f.hasEdge(e5)) {System.out.println("Test 18.2.9 FAIL");}				
		...
		graph.formFaces();		
		f = graph.getOuterFace();		
		if(!f.hasNode(n1)) {System.out.println("Test 18.3.1 FAIL");}
		if(!f.hasNode(n2)) {System.out.println("Test 18.3.2 FAIL");}	
		if(!f.hasNode(n3)) {System.out.println("Test 18.3.3 FAIL");}
		if(!f.hasNode(n4)) {System.out.println("Test 18.3.4 FAIL");}
		if(f.hasNode(n5)) {System.out.println("Test 18.3.5 FAIL");}
		if(!f.hasEdge(e1)) {System.out.println("Test 18.3.5 FAIL");}
		if(f.hasEdge(e2)) {System.out.println("Test 18.3.6 FAIL");}		
		if(!f.hasEdge(e3)) {System.out.println("Test 18.3.7 FAIL");}	
		if(!f.hasEdge(e4)) {System.out.println("Test 18.3.8 FAIL");}	
		if(!f.hasEdge(e5)) {System.out.println("Test 18.3.9 FAIL");}			
		if(f.hasEdge(e6)) {System.out.println("Test 18.3.8 FAIL");}	
		if(f.hasEdge(e7)) {System.out.println("Test 18.3.9 FAIL");}			
		...
		if(!f.hasNode(n1)) {System.out.println("Test 18.4.1 FAIL");}
		if(!f.hasNode(n2)) {System.out.println("Test 18.4.2 FAIL");}	
		if(!f.hasNode(n3)) {System.out.println("Test 18.4.3 FAIL");}
		if(!f.hasNode(n4)) {System.out.println("Test 18.4.4 FAIL");}
		if(f.hasNode(n5)) {System.out.println("Test 18.4.5 FAIL");}
		if(f.hasNode(n6)) {System.out.println("Test 18.4.6 FAIL");}
		if(f.hasNode(n7)) {System.out.println("Test 18.4.7 FAIL");}	
		if(f.hasNode(n8)) {System.out.println("Test 18.4.8 FAIL");}		
		if(!f.hasEdge(e1)) {System.out.println("Test 18.4.9 FAIL");}
		if(f.hasEdge(e2)) {System.out.println("Test 18.4.10 FAIL");}		
		if(!f.hasEdge(e3)) {System.out.println("Test 18.4.11 FAIL");}	
		if(!f.hasEdge(e4)) {System.out.println("Test 18.4.12 FAIL");}	
		if(!f.hasEdge(e5)) {System.out.println("Test 18.4.13 FAIL");}			
		if(f.hasEdge(e6)) {System.out.println("Test 18.4.14 FAIL");}	
		if(f.hasEdge(e7)) {System.out.println("Test 18.4.15 FAIL");}					
		if(f.hasEdge(e8)) {System.out.println("Test 18.4.16 FAIL");}	
		if(f.hasEdge(e9)) {System.out.println("Test 18.4.17 FAIL");}			
		if(f.hasEdge(e10)) {System.out.println("Test 18.4.18 FAIL");}	
		if(f.hasEdge(e11)) {System.out.println("Test 18.4.19 FAIL");}				
		
	
		Node n9 = new Node("n10", new Point(100,120));
		Edge e12 = new Edge(n1,n9);
		...
		graph.formFaces();
		f = graph.getOuterFace();	
		if(!f.hasNode(n1)) {System.out.println("Test 18.5.1 FAIL");}
		if(!f.hasNode(n2)) {System.out.println("Test 18.5.2 FAIL");}	
		if(!f.hasNode(n3)) {System.out.println("Test 18.5.3 FAIL");}
		if(!f.hasNode(n4)) {System.out.println("Test 18.5.4 FAIL");}
		if(f.hasNode(n5)) {System.out.println("Test 18.5.5 FAIL");}
		if(f.hasNode(n6)) {System.out.println("Test 18.5.6 FAIL");}
		if(f.hasNode(n7)) {System.out.println("Test 18.5.7 FAIL");}	
		if(f.hasNode(n8)) {System.out.println("Test 18.5.8 FAIL");}	
		if(f.hasNode(n9)) {System.out.println("Test 18.5.9 FAIL");}			
	
		if(!f.hasEdge(e1)) {System.out.println("Test 18.5.11 FAIL");}
		if(f.hasEdge(e2)) {System.out.println("Test 18.5.12 FAIL");}		
		if(!f.hasEdge(e3)) {System.out.println("Test 18.5.13 FAIL");}	
		if(!f.hasEdge(e4)) {System.out.println("Test 18.5.14 FAIL");}	
		if(!f.hasEdge(e5)) {System.out.println("Test 18.5.15 FAIL");}			
		if(f.hasEdge(e6)) {System.out.println("Test 18.5.16 FAIL");}	
		if(f.hasEdge(e7)) {System.out.println("Test 18.5.17 FAIL");}					
		if(f.hasEdge(e8)) {System.out.println("Test 18.5.18 FAIL");}	
		if(f.hasEdge(e9)) {System.out.println("Test 18.5.19 FAIL");}			
		if(f.hasEdge(e10)) {System.out.println("Test 18.5.20 FAIL");}	
		if(f.hasEdge(e11)) {System.out.println("Test 18.5.21 FAIL");}
		if(f.hasEdge(e12)) {System.out.println("Test 18.5.20 FAIL");}	
	...
	public static void testF() {
		...
		Graph g = new Graph();
		Node n0 = new Node("n0");
		n0.setCentre(new Point(0,0));		
		Node n1 = new Node("n1");
		n1.setCentre(new Point(491,400));
		Node n2 = new Node("n2");
		n2.setCentre(new Point(315,56));
		Node n3 = new Node("n3");
		n3.setCentre(new Point(322,363));
		
		Edge e0 = new Edge(n2,n0);
		Edge e1 = new Edge(n3,n1);
		Edge e2 = new Edge(n0,n3);
		...
		g.formFaces();
		Face f0 = g.getOuterFace();
		ArrayList<Node[]> temp0 = f0.generateTrisNodeList();

		for(Node[] nList: temp0){
			if(nList.length!=3){
		...
		Node a8 = new Node();
		Node a9 = new Node();
		a0.setCentre(new Point(138,322));
		a1.setCentre(new Point(249,369));
		a2.setCentre(new Point(87,325));
		a3.setCentre(new Point(146,166));		
		a4.setCentre(new Point(236,140));
		a5.setCentre(new Point(328,145));
		a6.setCentre(new Point(418,160));
		a7.setCentre(new Point(480,230));
		a8.setCentre(new Point(460,319));
		a9.setCentre(new Point(358,368));	
		...
		Edge b0 = new Edge(a3,a2);
		Edge b1 = new Edge(a2,a0);
		Edge b2 = new Edge(a0,a1);
		Edge b3 = new Edge(a1,a9);		
		Edge b4 = new Edge(a6,a5);
		Edge b5 = new Edge(a5,a4);
		Edge b6 = new Edge(a4,a3);
		Edge b7 = new Edge(a8,a9);		
		Edge b8 = new Edge(a6,a7);
		Edge b9 = new Edge(a7,a8);		
		...
		g1.formFaces();		
		Face f = g1.getOuterFace();
		ArrayList<Node[]> temp1 = f.generateTrisNodeList();
	
		for(Node[] nList: temp1){
			if(nList.length!=3){
		...
		if(!pjr.graph.Util.linesCross(p1, p2, p3, p4)) {System.out.println("Test 21.1.1 Fail");}
		if(!pjr.graph.Util.linesCross(p2, p1, p3, p4)) {System.out.println("Test 21.1.2 Fail");}
		if(!pjr.graph.Util.linesCross(p1, p2, p4, p3)) {System.out.println("Test 21.1.3 Fail");}
		if(!pjr.graph.Util.linesCross(p2, p1, p4, p3)) {System.out.println("Test 21.1.4 Fail");}
		if(!pjr.graph.Util.linesCross(p3, p4, p1, p2)) {System.out.println("Test 21.1.5 Fail");}
		if(!pjr.graph.Util.linesCross(p3, p4, p2, p1)) {System.out.println("Test 21.1.6 Fail");}
		if(!pjr.graph.Util.linesCross(p4, p3, p1, p2)) {System.out.println("Test 21.1.7 Fail");}
		if(!pjr.graph.Util.linesCross(p4, p3, p2, p1)) {System.out.println("Test 21.1.8 Fail");}
		if(pjr.graph.Util.linesCross(p1, p3, p2, p4)) {System.out.println("Test 21.1.9 Fail");}
		if(pjr.graph.Util.linesCross(p4, p1, p3, p2)) {System.out.println("Test 21.1.10 Fail");}
		p1 = new Point(200,200);
		p2 = new Point(400,200);
		p3 = new Point(300,100);
		p4 = new Point(300,500);
		if(!pjr.graph.Util.linesCross(p1, p2, p3, p4)) {System.out.println("Test 21.1.11 Fail");}
		if(!pjr.graph.Util.linesCross(p4, p3, p2, p1)) {System.out.println("Test 21.1.12 Fail");}
		if(!pjr.graph.Util.linesCross(p1, p2, p1, p4)) {System.out.println("Test 21.1.13 Fail");}
		if(!pjr.graph.Util.linesCross(p4, p2, p2, p1)) {System.out.println("Test 21.1.14 Fail");}
		if(pjr.graph.Util.linesCross(p1, p3, p2, p4)) {System.out.println("Test 21.1.15 Fail");}
		if(pjr.graph.Util.linesCross(p4, p1, p3, p2)) {System.out.println("Test 21.1.16 Fail");}
		
		if(!pjr.graph.Util.linesCross(p2, p1, p1, p2)) {System.out.println("Test 21.1.17 Fail");}
		if(!pjr.graph.Util.linesCross(p1, p2, p1, p2)) {System.out.println("Test 21.1.18 Fail");}
		
		p1 = new Point(200,200);
		p2 = new Point(400,200);
		p3 = new Point(300,300);
		p4 = new Point(500,300);
		if(pjr.graph.Util.linesCross(p1, p2, p3, p4)) {System.out.println("Test 21.1.17 Fail");}
		if(pjr.graph.Util.linesCross(p4, p3, p2, p1)) {System.out.println("Test 21.1.18 Fail");}
		if(pjr.graph.Util.linesCross(p2, p1, p4, p3)) {System.out.println("Test 21.1.19 Fail");}
		if(pjr.graph.Util.linesCross(p3, p4, p1, p2)) {System.out.println("Test 21.1.20 Fail");}
