 ...
 */
	public void drawGraph() {
		...
		if(scaleWeightsToUnitary) {
			edgeWeightFactor = Double.MIN_VALUE;
		...
		maxSpringForce = Double.MAX_VALUE;
...
for(DrawCoord nb : nodeBuffer.getBufferedNodes()) {
	 ...
	 */
	boolean sameIntegerLocation(ArrayList l1, ArrayList l2) {
		if(l1.size() != l2.size()) {
			return false;
		}
...
/**
 * Puts any numeric value in the edge lable
