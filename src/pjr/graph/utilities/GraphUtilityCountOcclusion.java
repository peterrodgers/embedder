...
public class GraphUtilityCountOcclusion extends GraphUtility implements Serializable {
...
//		fred.add(new Integer(1));
//		fred.add(new Integer(2));
		for(int i = 0; i < 100; i++) {
			Integer z = (Integer)fred.get(random.nextInt(fred.size()));
			System.out.println(limit-GraphUtilityOccludeGraph.randrange(0,limit*2+1)+" "+z);
		}
	}
