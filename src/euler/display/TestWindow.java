...
public class TestWindow extends JFrame implements ActionListener {
	...
	//dg.randomizeNodePoints(new Point(50,50),400,400);
		...
		TestWindow dw = new TestWindow(dg);
	...
	public TestWindow(DualGraph dg) {
...
//		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_W, "Create Wellformed 4 Set Euler Dual",KeyEvent.VK_W,4,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_2, "Create Wellformed 2 Set Euler Dual",KeyEvent.VK_2,2,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_3, "Create Wellformed 3 Set Euler Dual",KeyEvent.VK_3,3,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_4, "Create Wellformed 4 Set Euler Dual",KeyEvent.VK_4,4,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_5, "Create Wellformed 5 Set Euler Dual",KeyEvent.VK_5,5,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_6, "Create Wellformed 6 Set Euler Dual",KeyEvent.VK_6,6,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_7, "Create Wellformed 7 Set Euler Dual",KeyEvent.VK_7,7,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_8, "Create Wellformed 8 Set Euler Dual",KeyEvent.VK_8,8,true));
		dp.addDiagramUtility(new DiagramUtilityRandomWellformedDiagram(KeyEvent.VK_9, "Create Wellformed 9 Set Euler Dual",KeyEvent.VK_9,9,true));
