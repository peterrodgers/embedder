...
import euler.library.EditContourDialog;


public class PiercingDiagramPanel extends DiagramPanel implements MouseListener, MouseMotionListener, KeyListener {
	...
	public PiercingDiagramPanel(PiercingDiagram pd, Applet inApplet) {
		super();		
		piercingDiagram = pd;
		constructedConcreteDiagram = piercingDiagram.generateConstructedConcreteDiagram();	
		containerFrame = null;
		containerApplet = inApplet;
		setup();
	}

	public PiercingDiagramPanel(PiercingDiagram pd) {
		super();
		piercingDiagram = pd;
		constructedConcreteDiagram = piercingDiagram.generateConstructedConcreteDiagram();	
	...
	public void setPiercingDiagram(PiercingDiagram pd){
		this.piercingDiagram = pd;
	}
