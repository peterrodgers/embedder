...
public class ConstructedDiagramWindow extends JFrame implements ActionListener {
	...
	public static String DEFAULT_WIN_TITLE = "Constructed Diagram Editor ConstructedDiagramWindow.java"; 
	...
	protected ESE_rep_ext2 diagramDrawerForceDirected = new ESE_rep_ext2();
	...
	public static void main(String[] args) {
		...
		ConstructedDiagramWindow cdw = new ConstructedDiagramWindow("", ccs, dp);
		cdw.getConstructedDiagramPanel().setShowEdgeDirection(false);
		cdw.getConstructedDiagramPanel().setShowEdgeLabel(true);
		cdw.getConstructedDiagramPanel().setShowGraph(false);
		...
		cdw.getConstructedDiagramPanel().setShowEdgeLabel(true);
		cdw.getConstructedDiagramPanel().setJiggleLabels(false);
		cdw.getConstructedDiagramPanel().setShowRegion(false);
		cdw.getConstructedDiagramPanel().setShowContour(true);
		cdw.getConstructedDiagramPanel().setShowTriangulation(false);
		cdw.getConstructedDiagramPanel().setShowEdgeLabel(false);
		cdw.getConstructedDiagramPanel().setShowContourLabel(true);
		cdw.getConstructedDiagramPanel().setShowContourAreas(false);
		cdw.getConstructedDiagramPanel().setOptimizeContourAngles(false);
		cdw.getConstructedDiagramPanel().setOptimizeMeetingPoints(false);
		cdw.getConstructedDiagramPanel().setFitCircles(false);
		
		cdw.getConstructedDiagramPanel().requestFocus();
		*/
	}
	
	
	public ConstructedDiagramWindow(String abstractDescription, ArrayList<ConcreteContour> inConcreteContours, DiagramPanel inDp, ESE_rep_ext2 inDiagramDrawerForceDirected) {
	...
	public void initMenu() {
		...
		JMenuItem fileSaveDualGraphItem = new JMenuItem("Save Dual Graph...");
